...
#### Reading: Consider accessibility when creating personas, user stories, and user journey maps
...
- How accessibility in technology changes lives: [How the Blind Use Technology](https://www.youtube.com/watch?v=0EQOZRIA-nA) to See The World from TEDx Talks on YouTube
...
##### Curb cut 
A curb cut is the name for the slope of the sidewalk that creates a ramp with the adjoining street. Curb cuts are usually found at intersections.
